...
\item If we choose A and b such that the hyperplanes intersect at the same point then we CVX finds a center with radius zero.
...
\end{align*}
This is still an LP problem since the inequalities are still linear.
...
(where either $\|x_1\| =1 \text{ and } \| x_2 \| \le 1 \text{ or } \| x_2 \| \le 1 \text{ and } \| x_ 2|| = 1$,  (fig. ~\ref{fig5})).
